class Environment {
  ...
  createRoad() {
    ...
    const courseLayout = [
      ...
      { segments: 5, turnRate: -0.1 }, // Sweeping left
      ...
      { segments: 7, turnRate: 0.1 }, // Sweeping right descent
      ...
      { segments: 6, turnRate: -0.1 }, // Coastal sweep left
      { segments: 2, turnRate: 0 }, // Short link
      ...
      { segments: 5, turnRate: 0.1 }, // Right curve
